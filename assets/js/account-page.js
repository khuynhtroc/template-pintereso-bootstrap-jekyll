    ...
    switch (tabId) {
      ...
      case 'orders': {
        ...
        orders.forEach(order => {
          const itemName = planMap.get(order.plan_id) || productMap.get(order.product_id) || 'Sản phẩm lẻ';
        ...
        pane.innerHTML = `
          ...
          <form id="profile-update-form">
            <div class="mb-3">
              ...
              <div class="form-text">${canEditUsername ? 'Bạn chỉ có thể đặt username một lần.' : 'Username không thể thay đổi.'}</div>
            </div>
