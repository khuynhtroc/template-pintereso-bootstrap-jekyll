document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateUserDisplay = (user) => {
        ...
        if (user) {
            ...
            if(headerAvatar) headerAvatar.src = user.user_metadata?.avatar_url || '/assets/images/default-avatar.png';
            headerLoginLink.href = '/account/';
        } else {
            headerAuthText.textContent = 'Đăng nhập';
            if(headerAvatar) headerAvatar.src = '/assets/images/default-avatar.png';
